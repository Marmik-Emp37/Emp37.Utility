...
namespace Emp37.Utility
{
      ...
      public static class ReflectionUtility
      {
            ...
            public static object AutoInvokeMethod(string name, object target, string[] argNames = null, BindingFlags flags = DEFAULT_FLAGS) => AutoInvokeMethod(FindMethod(name, target.GetType()), target, argNames, flags);
      }
}