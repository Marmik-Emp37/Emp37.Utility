...
namespace Emp37.Utility
{
      public static class Extensions
      {
            ...
            public static void ApplyShade(this Image renderer, Shades shade, byte alpha = byte.MaxValue) => renderer.color = ShadeLibrary.Pick(shade).WithAlpha(alpha);
            public static void ApplyShade(this SpriteRenderer renderer, Shades shade, byte alpha = byte.MaxValue) => renderer.color = ShadeLibrary.Pick(shade).WithAlpha(alpha);
            #endregion
